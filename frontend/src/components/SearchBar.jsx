	...
	return (
		<div className='relative mt-1 flex'>
			<input
				type='text'
				id='password'
				className='w-full pl-3 mx-2 pr-10 py-2 border-2 border-gray-100 rounded-3xl hover:border-gray-300 focus:outline-none focus:border-gray-300 transition-colors'
				placeholder='Buscar'
			/>
			<button className='block w-7 h-7 text-center text-xl leading-0 absolute top-2 right-3.5 text-gray-400 focus:outline-none hover:text-gray-900 transition-colors'>
				<svg
					version='1.1'
				...
				>
					<g>
						<path
							d='M49.988,0h0.016v0.007C63.803,0.011,76.298,5.608,85.34,14.652c9.027,9.031,14.619,21.515,14.628,35.303h0.007v0.033v0.04 
            ...
            c0.004-13.799,5.601-26.296,14.645-35.338C23.683,5.608,36.167,0.016,49.955,0.007V0H49.988L49.988,0z M50.004,11.21v0.007h-0.016 
            h-0.033V11.21c-10.686,0.007-20.372,4.35-27.384,11.359C15.56,29.578,11.213,39.274,11.21,49.973h0.007v0.016v0.033H11.21 
