	...
	return (
		<footer className='bg-white py-4 border-t border-gray-300'>
			<div className='max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center px-7 space-y-4 md:space-y-0'>
				...
				<div className='w-full md:w-1/3 flex flex-col md:text-left order-2 md:order-1'>
				...
				<div className='flex justify-start md:justify-center space-x-6 w-full md:w-1/3 order-1 md:order-2'>
					<svg
						...
						strokeWidth={1.5}
						stroke='currentColor'
						className='w-6 h-6 text-gray-600 hover:text-gray-900 transition-colors mb-4'
					>
						<path
							strokeLinecap='round'
				...
				<div className='md:text-right w-full md:w-1/3 order-3 md:order-3'>
